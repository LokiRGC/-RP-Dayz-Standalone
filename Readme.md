...
Готово, мод установлен, админка прописана. Запускаем сервер, заходим. Сразу открываем настройки привязки клавиш, заходим во вкладку `"VPP"` и настраиваем на удобные вам клавиши.
...
```
## Добавление Оружия
Данные модификации идут на ваш вкус и цвет.
![image](https://github.com/user-attachments/assets/ec611e6b-ec4f-4e84-b9d8-14d3ddb01c55)
- Из популярных модификаций [@SNAFU Weapons](https://steamcommunity.com/sharedfiles/filedetails/?id=2443122116)

![image](https://github.com/user-attachments/assets/e0676e1f-8c17-486e-a0c3-06b80ca6c096)
- Из популярных модификаций [@Tactical Flava](https://steamcommunity.com/sharedfiles/filedetails/?id=2646817942)

Все эти модификации, устанавливаем точно так же, как и @CF, @VPPAdminTools.
Эти модификации пригодятся нам для дальнейшей работы.

## Добавление Одежды и Бронежилетов
Данные модификации идут на ваш вкус и цвет.
![image](https://github.com/user-attachments/assets/e9bfc945-f104-46e4-b144-63c0f2dfb628)
- Из популярных модификаций [@Equipment System OLD](https://steamcommunity.com/sharedfiles/filedetails/?id=3142031973)
...
## Обучаемся Ретекстуру
## Обучаемся Config.cpp
